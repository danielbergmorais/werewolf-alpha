...
export class HomePage {
  ...
  bgAudio() {
    const path_android = 'public/assets/sounds'
    //const path_android = '/'

    NativeAudio.preload({
      assetId: 'bgAudio',
      assetPath: path_android + '/bg.mp3',
      isUrl: false
    });

    NativeAudio.preload({
      assetId: 'begin',
      assetPath: path_android + '/begin.mp3',
      isUrl: false
    });

    NativeAudio.preload({
      assetId: 'end',
      assetPath: path_android + '/end.mp3',
      isUrl: false
    });

    NativeAudio.preload({
      assetId: 'begin_vampire',
      assetPath: path_android + '/begin-vampire.mp3',
      isUrl: false
    });

    NativeAudio.preload({
      assetId: 'end_vampire',
      assetPath: path_android + '/end-vampire.mp3',
      isUrl: false
    });

    NativeAudio.preload({
      assetId: 'amantes',
      assetPath: path_android + '/amantes.mp3',
      isUrl: false
    });
    ...
    NativeAudio.preload({
      assetId: 'vampiros_a',
      assetPath: path_android + '/vampire/vampiros/vampiros-a.mp3',
      isUrl: false
    });
